...
<li><a href="<misc:url value="/Query/motif"><spring:param name="taxons" value="${taxonNodeName}"/></misc:url>">Motifs</a></li>
</ul>
<!-- end sub menu -->
</li>
...
<p>&copy; 2009-2018 and hosted by the <a href="http://www.sanger.ac.uk/">Sanger Institute</a></p>
</td>
