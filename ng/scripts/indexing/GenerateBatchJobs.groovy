...
for (org in orgs) {
	...
	def processExecLine = "source /etc/bashrc; source /nfs/users/nfs_p/pathdb/.bash_profile; bsub -q ${queueName} -R 'select[mem>4000] rusage[mem=4000, pathdbsrv1tok=1250]' -M 4000 -o ${outFileName} -e ${errFileName} ${scriptName}"
